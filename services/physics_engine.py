...
class PhysicsEngine(WaveformMixin, ArbitrationMixin, ProtectionMixin, MeasurementMixin):
    def __init__(
        ...
        *,
        ...
        # self.color_sw1, self.color_sw2 = "k", "k"  # overcurrent heat-color switch UI disabled
        self.i1_rms = 0
        # self.ip1, self.iq1 = 0, 0  # CT/Ip/Iq numeric topology UI disabled
        self.i2_rms = 0
        # self.ip2, self.iq2 = 0, 0  # CT/Ip/Iq numeric topology UI disabled
