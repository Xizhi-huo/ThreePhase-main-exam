...
In the exam build the student operates the engine and breaker controls manually;
breaker/protection logic then decides whether the final Gen2 close succeeds.
"""
